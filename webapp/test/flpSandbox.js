		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Importação NF Fornecedor - Estoque de Terceiro",
									"targetURL": "#comseidorzuxmmz42xml-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comseidorzuxmmz42xml-display": {
								"semanticObject": "comseidorzuxmmz42xml",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.seidor.zuxmmz42xml",
									"url": sap.ui.require.toUrl("com/seidor/zuxmmz42xml")
								}
							}
						}
					}
